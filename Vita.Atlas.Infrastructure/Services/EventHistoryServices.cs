...
public sealed class ResourcePlanEntryHistoryService : IResourcePlanEntryHistoryService
{
    ...
    public ResourcePlanEntryHistoryService(AtlasDbContext dbContext, ICorrelationContext correlationContext)
    {
...
public sealed class BusinessEventService : IBusinessEventService
{
    ...
    public BusinessEventService(AtlasDbContext dbContext, ICorrelationContext correlationContext)
    {
        _dbContext = dbContext;
        _correlationContext = correlationContext;
    }
